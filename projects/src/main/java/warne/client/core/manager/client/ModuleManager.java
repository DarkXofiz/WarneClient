...
import warne.client.features.hud.impl.*;
import warne.client.features.modules.Module;
import warne.client.features.modules.client.*;
import warne.client.features.modules.combat.*;
import warne.client.features.modules.misc.*;
import warne.client.features.modules.movement.Timer;
import warne.client.features.modules.movement.*;
import warne.client.features.modules.player.*;
import warne.client.features.modules.render.Particles;
import warne.client.features.modules.render.*;
...
public class ModuleManager implements IManager {
    ...
    public static WarneClientGui thunderHackGui = new WarneClientGui();
    ...
    public void onLoad(String category) {
        try {
            WarneClient.EVENT_BUS.unsubscribe(unHook);
        ...
        modules.forEach(m -> {
            if (m.isEnabled() && (m.getCategory().getName().equalsIgnoreCase(category) || category.equals("none")))
                WarneClient.EVENT_BUS.subscribe(m);
        });
    ...
    public void onRender2D(DrawContext context) {
        ...
        WarneClient.core.onRender2D(context);
    }
    ...
    public void onUnload(String category) {
        modules.forEach(module -> {
            if (module.isEnabled() && (module.getCategory().getName().equalsIgnoreCase(category) || category.equals("none"))) {
                WarneClient.EVENT_BUS.unsubscribe(module);
    ...
    public void registerModule(Module module) {
        ...
        if (module.isEnabled())
            WarneClient.EVENT_BUS.subscribe(module);
    }
