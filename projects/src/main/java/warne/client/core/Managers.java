...
import warne.client.core.manager.client.*;
import warne.client.core.manager.player.CombatManager;
import warne.client.core.manager.player.FriendManager;
import warne.client.core.manager.player.PlayerManager;
import warne.client.core.manager.world.HoleManager;
import warne.client.core.manager.world.WayPointManager;
import warne.client.utility.ThunderUtility;

import static warne.client.WarneClient.EVENT_BUS;

/**
 * Class with all WarneClient Managers' instances
 *
 * @author 06ED
 * @see IManager - base interface for all managers
 * @see WarneClient - managers init process
 * @since 1.7
 */
