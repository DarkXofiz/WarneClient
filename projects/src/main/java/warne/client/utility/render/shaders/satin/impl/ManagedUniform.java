 ...
 */
package warne.client.utility.render.shaders.satin.impl;

import warne.client.utility.render.shaders.satin.api.managed.uniform.Uniform1f;
import warne.client.utility.render.shaders.satin.api.managed.uniform.Uniform1i;
import warne.client.utility.render.shaders.satin.api.managed.uniform.Uniform2f;
import warne.client.utility.render.shaders.satin.api.managed.uniform.Uniform2i;
import warne.client.utility.render.shaders.satin.api.managed.uniform.Uniform3f;
import warne.client.utility.render.shaders.satin.api.managed.uniform.Uniform3i;
import warne.client.utility.render.shaders.satin.api.managed.uniform.Uniform4f;
import warne.client.utility.render.shaders.satin.api.managed.uniform.Uniform4i;
import warne.client.utility.render.shaders.satin.api.managed.uniform.UniformMat4;
