package warne.client.utility.render.shaders;
...
import warne.client.utility.render.WindowResizeCallback;
import warne.client.utility.render.shaders.satin.api.managed.ManagedCoreShader;
import warne.client.utility.render.shaders.satin.api.managed.ShaderEffectManager;
import warne.client.utility.render.shaders.satin.api.managed.uniform.SamplerUniform;
...
public class BlurProgram {
    ...
    public static final ManagedCoreShader BLUR = ShaderEffectManager.getInstance()
            .manageCoreShader(Identifier.of("warneclient", "blur"), VertexFormats.POSITION);
