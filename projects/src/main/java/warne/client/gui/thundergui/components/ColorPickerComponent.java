...
public class ColorPickerComponent extends SettingElement {
    ...
    public void mouseClicked(int mouseX, int mouseY, int button) {
        ...
        if (copy_focused) WarneClient.copy_color = getColorSetting().getColorObject();
        if (paste_focused)
            setColor(WarneClient.copy_color == null ? getColorSetting().getColorObject() : WarneClient.copy_color);
    }
