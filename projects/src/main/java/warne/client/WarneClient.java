...
import warne.client.core.hooks.ManagerShutdownHook;
import warne.client.core.hooks.ModuleShutdownHook;
...
public class WarneClient implements ModInitializer {
    public static final ModMetadata MOD_META;

    public static final String MOD_ID = "warneclient";
    public static final String NAME = "Warne Client";
    ...
    public void onInitialize() {
        ...
        EVENT_BUS.registerLambdaFactory("warne.client",
        ...
        LOGGER.info("[Warne Client] Init time: {} ms.", System.currentTimeMillis() - initTime);
        initTime = System.currentTimeMillis();
    ...
    public enum KeyListening {
        WarneGui, ClickGui, Search, Sliders, Strings, ThunderGui
    }
}
