package warne.client.features.modules.movement;
...
import warne.client.features.modules.combat.Criticals;
...
import warne.client.utility.player.MovementUtility;
...
import static warne.client.features.modules.player.ElytraSwap.getChestPlateSlot;
...
public class ElytraPlus extends Module {
    ...
    private final warne.client.utility.Timer startTimer = new warne.client.utility.Timer();
    private final warne.client.utility.Timer redeployTimer = new warne.client.utility.Timer();
    private final warne.client.utility.Timer strictTimer = new warne.client.utility.Timer();
    private final warne.client.utility.Timer pingTimer = new warne.client.utility.Timer();
