...
import warne.client.utility.discord.DiscordEventHandlers;
import warne.client.utility.discord.DiscordRPC;
import warne.client.utility.discord.DiscordRichPresence;
...
public final class RPC extends Module {
    ...
    public static void readFile() {
        try {
            File file = new File("WarneClient/misc/RPC.txt");
            if (file.exists()) {
    ...
    public void startRpc() {
        ...
        if (!started) {
            ...
            presence.largeImageText = "v" + WarneClient.VERSION + " [" + WarneClient.GITHUB_HASH + "]";
            ...
            thread = new Thread(() -> {
                while (!Thread.currentThread().isInterrupted()) {
                    ...
                    switch (smode.getValue()) {
                        ...
                        case Version -> presence.state = "v" + WarneClient.VERSION +" for mc 1.21";
                    }
                    ...
                    presence.button_url_1 = "https://github.com/Yukile394/WarneClient/";
