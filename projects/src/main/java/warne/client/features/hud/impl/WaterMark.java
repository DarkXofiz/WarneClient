...
import warne.client.features.modules.client.Media;
...
import warne.client.utility.render.TextUtil;
...
public class WaterMark extends HudElement {
    ...
    public void onRender2D(DrawContext context) {
        ...
        if (mode.getValue() == Mode.Big) {
            ...
            FontRenderers.thglitch.drawString(context.getMatrices(), "WARNE CLIENT", getPosX() + 5.5, getPosY() + 5, -1);
            FontRenderers.monsterrat.drawGradientString(context.getMatrices(), "recode", getPosX() + 35.5f, getPosY() + 21f, 1);
            FontRenderers.settings.drawString(context.getMatrices(), "Kurucusu: Yukile", getPosX() + 5.5f, getPosY() + 22f, new Color(0x8D8D8D).getRGB());
            ...
            if (HudEditor.hudStyle.is(HudEditor.HudStyle.Blurry)) {
                ...
                float width = FontRenderers.sf_bold.getStringWidth("WarneClient " + info) + 5;
                Render2DEngine.drawHudBase(context.getMatrices(), getPosX(), getPosY(), width, 10, 3);
                FontRenderers.sf_bold.drawGradientString(context.getMatrices(), ru.getValue() ? textUtil + " " : "WarneClient ", getPosX() + 2, getPosY() + 2.5f, 10);
                FontRenderers.sf_bold.drawString(context.getMatrices(), info, getPosX() + 2 + FontRenderers.sf_bold.getStringWidth("WarneClient "), getPosY() + 2.5f, HudEditor.textColor.getValue().getColor());
            ...
            FontRenderers.monsterrat.drawGradientString(context.getMatrices(), "WarneClient v" + WarneClient.VERSION, getPosX() + 5.5f, getPosY() + 5, 10);
