...
public class Aura extends Module {
    ...
    public void onEnable() {
        ...
        /*
         * FIX: Aura açıldığı anda hedef kilidi de otomatik ve zorunlu olarak
         * açılıyor. Eskiden LockTarget ayrı bir seçenekti ve kapalıysa (ya
         * da Sort=FOV / bir mermi sahneye girince) hedef her tick yeniden
         * seçilebiliyordu — "birine vurunca başka oyuncuya geçme" sorunu
         * buradan geliyordu. Artık Aura her açıldığında LockTarget da
         * zorla true'ya çekiliyor; kullanıcı ayardan kapatmaya çalışsa
         * bile hedefin asla kaymaması garanti ediliyor (bkz. updateTarget()).
         */
        lockTarget.setValue(true);
    }
    ...
    private void updateTarget() {
        ...
        /*
         * FIX: LockTarget açıkken (artık Aura her açılışta zorla açıyor)
         * hedef HİÇBİR istisna olmadan sabit kalır. Eskiden Sort=FOV modu
         * ve "candidat bir mermiyse" durumu bu kilidi bypass edip hedefi
         * anlık değiştirebiliyordu — "birine vurunca diğerine geçme"
         * sorununun asıl kaynağı buydu. Artık kilit varken bu iki istisna
         * da devre dışı; hedef sadece skipEntity() onu geçersiz kıldığında
         * (öldü, menzil dışı, görünmez vs.) bırakılır.
         */
        if (!lockTarget.getValue()) {
            if (sort.getValue() == Sort.FOV || candidat instanceof ProjectileEntity)
                target = candidat;
        }
