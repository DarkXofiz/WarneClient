...
public class Aura extends Module {
    ...
    public void onSync(EventSync e) {
        ...
        // ElytraTarget modülü aktifken ve biz elytra ile uçarken, dönüş kontrolünü
        // ona bırak; aksi halde iki modül aynı anda yaw/pitch set edip birbirini
        // ezerek titrek/bozuk bir nişan alma davranışına yol açıyordu.
        boolean deferToElytraTarget = elytraTarget.getValue()
                && mc.player.isFallFlying()
                && ModuleManager.elytraTarget.isEnabled();

        if (target != null && rotationMode.getValue() != Mode.None && rotationMode.getValue() != Mode.Grim && !deferToElytraTarget) {
