...
public final class ElytraTarget extends Module {
    ...
    private void fireRocket() {
        ...
        if (rocketSlot == -1) {
            ...
            // NOT: roket hotbar dışında (ana envanterde) bulundu. Onu hotbar'a
            // taşıyacak bir envanter-swap paketi bu sınıfın erişebildiği API'de yok.
            // InventoryUtility'de böyle bir metot (örn. moveToHotbar veya benzeri)
            // varsa adını ver, buraya doğru çağrıyı ekleyeyim. O metot doğrulanana
            // kadar burada güvenli tarafta kalıp ateşlemeden çıkıyoruz; bu da
            // AutoSwitchRocket ayarının şu an sadece hotbar-içi roket bulunduğunda
            // (rocketSlot != -1 durumunda) etkili olduğu, envanterden taşımanın
            // henüz uygulanmadığı anlamına geliyor.
            return;
        }
