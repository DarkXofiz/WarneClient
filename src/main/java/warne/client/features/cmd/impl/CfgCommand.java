...
import warne.client.features.cmd.args.CategoryArgumentType;
import warne.client.features.cmd.args.CfgArgumentType;
import warne.client.features.cmd.args.ModuleArgumentType;
...
public class CfgCommand extends Command {
    ...
    public void executeBuild(@NotNull LiteralArgumentBuilder<CommandSource> builder) {
        ...
        builder.then(literal("dir").executes(context -> {
            try {
                net.minecraft.util.Util.getOperatingSystem().open(new File("WarneClientRecode/configs/").toURI());
            } catch (Exception e) {
                e.printStackTrace();
            }
            return SINGLE_SUCCESS;
