package warne.client.gui.mainmenu;
...
import warne.client.api.IAddon;
...
public class MainMenuScreen extends Screen {
    ...
    public void render(@NotNull DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        FontRenderers.thglitchBig.drawCenteredString(context.getMatrices(), "WARNE CLIENT", (int) (halfOfWidth), (int) (halfOfHeight - 120), new Color(255, 255, 255, hoveredLogo ? 230 : 180).getRGB());
        ...
        FontRenderers.sf_medium.drawString(context.getMatrices(), "Kurucusu: Yukile", halfOfWidth * 2 - FontRenderers.sf_medium.getStringWidth("Kurucusu: Yukile") - 5f, halfOfHeight * 2 - 10, Render2DEngine.applyOpacity(-1, 0.4f));
    ...
    public boolean mouseClicked(double mouseX, double mouseY, int button) {
        ...
        if (Render2DEngine.isHovered(mouseX, mouseY, (int) (halfOfWidth - 157), (int) (halfOfHeight - 140), 300, 70))
            Util.getOperatingSystem().open(URI.create("https://warneclient-site.vercel.app/"));
