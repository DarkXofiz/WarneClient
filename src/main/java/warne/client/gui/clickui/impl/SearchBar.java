...
import warne.client.gui.clickui.AbstractButton;
...
public class SearchBar extends AbstractButton {
    ...
    public void mouseClicked(int mouseX, int mouseY, int button) {
        ...
        if (listening) WarneClient.currentKeyListener = WarneClient.KeyListening.Search;
    }
    ...
    public void keyTyped(int keyCode) {
        ...
        if (keyCode == GLFW.GLFW_KEY_F && (InputUtil.isKeyPressed(mc.getWindow().getHandle(), GLFW.GLFW_KEY_LEFT_CONTROL) || InputUtil.isKeyPressed(mc.getWindow().getHandle(), GLFW.GLFW_KEY_RIGHT_CONTROL))) {
            listening = !listening;
            WarneClient.currentKeyListener = WarneClient.KeyListening.Search;
            return;
        }

        if (WarneClient.currentKeyListener != WarneClient.KeyListening.Search)
            return;
